...
class MigrateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'rinvex:migrate:tenants {--f|force : Force the operation to run when in production.}';
    ...
    public function handle(): void
    {
        ...
        if (file_exists($path = 'database/migrations/rinvex/laravel-tenants')) {
            $this->call('migrate', [
                '--step' => true,
                '--path' => $path,
